...
```json
{
  ...
  "flatNumber": "≤50",              // e.g. "402" — optional
  "blockNumber": "≤50",             // e.g. "B" — optional
  "colonyName": "≤200",             // e.g. "Green Colony" — optional
  "street": "required, ≤200",
...
{
  "_id": "…", "label": "Home",
  "flatNumber": "402", "blockNumber": "B", "colonyName": "Green Colony",
  "street": "…", "additionalDetails": "…",
...
```
`PATCH /food/user/addresses/:addressId` accepts the same fields (all optional — partial update). **Same-label upsert**: saving a new address with a label that already exists (e.g. a second "Home") overwrites the existing one in place rather than adding a second entry — there is no way to have two addresses under the same label.
