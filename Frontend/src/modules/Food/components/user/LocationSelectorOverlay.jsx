...
/**
 * Blank address form. Kept in one place because the same literal was inlined at
 * the initial state and both reset sites — so a new address field had to be
 * added in three spots or it survived a reset and leaked into the next address.
 */
  ...
  const handleAddressFormSubmit = async (e) => {
    ...
    try {
      ...
      addressToSave = {
        ...
        flatNumber: (addressFormData.flatNumber || "").trim(),
        blockNumber: (addressFormData.blockNumber || "").trim(),
        colonyName: (addressFormData.colonyName || "").trim(),
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Input
                  ...
                  value={addressFormData.flatNumber || ""}
                  onChange={handleAddressFormChange}
                  className="bg-white dark:bg-[#1a1a1a] border-gray-200 dark:border-gray-700"
                />
                <Input
                  ...
                  value={addressFormData.blockNumber || ""}
                  onChange={handleAddressFormChange}
                  className="bg-white dark:bg-[#1a1a1a] border-gray-200 dark:border-gray-700"
                />
              </div>
              ...
              <Input
                name="colonyName"
                placeholder="Colony / Society name"
                value={addressFormData.colonyName || ""}
                onChange={handleAddressFormChange}
                className="bg-white dark:bg-[#1a1a1a] border-gray-200 dark:border-gray-700"
              />
              <div className="grid grid-cols-2 gap-2">
