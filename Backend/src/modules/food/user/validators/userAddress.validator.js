...
const createAddressSchema = z.object({
    ...
    flatNumber: z.string().max(50).optional().or(z.literal('')).transform((s) => String(s || '').trim()),
    blockNumber: z.string().max(50).optional().or(z.literal('')).transform((s) => String(s || '').trim()),
    colonyName: z.string().max(200).optional().or(z.literal('')).transform((s) => String(s || '').trim()),
