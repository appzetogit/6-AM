...
export const addAddress = async (userId, dto) => {
    ...
    if (existingIdx >= 0) {
        ...
        existing.flatNumber = address.flatNumber;
        existing.blockNumber = address.blockNumber;
...
export const updateAddress = async (userId, addressId, dto) => {
    ...
    if (dto.flatNumber !== undefined) address.flatNumber = dto.flatNumber || '';
    if (dto.blockNumber !== undefined) address.blockNumber = dto.blockNumber || '';
    if (dto.colonyName !== undefined) address.colonyName = dto.colonyName || '';
