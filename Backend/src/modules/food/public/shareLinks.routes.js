...
<title>${escapeHtml(title)} · 6AM Fresh</title>
<meta name="description" content="${escapeHtml(description)}" />
<link rel="canonical" href="${escapeHtml(canonical)}" />
<meta property="og:type" content="website" />
<meta property="og:site_name" content="6AM Fresh" />
...
<div class="card">
  ...
  <a class="btn primary" href="${escapeHtml(PLAY_STORE_URL)}">Get 6AM Fresh on Android</a>
  ${APP_STORE_URL ? `<a class="btn secondary" href="${escapeHtml(APP_STORE_URL)}">Get 6AM Fresh on iPhone</a>` : ''}
...
const notFoundPage = (req, res, what) =>
    sendPage(
        ...
        renderPage({
            ...
            description:
                'The link may have expired, or the item is no longer being served. Browse everything else on 6AM Fresh.',
            image: '',
    ...
    try {
        ...
        sendPage(
            ...
            renderPage({
                ...
                description: description || 'Order it on 6AM Fresh.',
